...
OWNER_NAME = getenv("OWNER_NAME", "Ryzen_xD")
ALIVE_NAME = getenv("ALIVE_NAME", "Ryzen_xD")
BOT_USERNAME = getenv("BOT_USERNAME", "VampireXmusicBot")
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "Vampirebot_zsupport")
GROUP_SUPPORT = getenv("GROUP_SUPPORT", "Vampirebotz_support")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "VampireBotz_official")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/MickeyxD/VampireXmusic")
